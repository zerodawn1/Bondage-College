...
function AssetAdd(NewAssetName, NewAssetVisible, NewAssetEffect, NewAssetValue, NewAssetHeightModifier) {
	var A = {
		Name: NewAssetName,
	...
	for (G = 0; G < A.length; G++) {
		...
		for (I = 0; I < A[G].Asset.length; I++)
			if (A[G].Asset[I].Name == null)
				AssetAdd(A[G].Asset[I], true, null, 0, 0)
			else
				AssetAdd(A[G].Asset[I].Name, A[G].Asset[I].Visible, A[G].Asset[I].Effect, A[G].Asset[I].Value, A[G].Asset[I].Height);

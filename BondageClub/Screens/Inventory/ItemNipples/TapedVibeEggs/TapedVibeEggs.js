...
function InventoryItemNipplesTapedVibeEggsSetIntensity(Modifier) {
	...
	ChatRoomPublishCustomAction((DialogFind(Player, "NippleEgg" + ((Modifier > 0) ? "Increase" : "Decrease") + "To" + DialogFocusItem.Property.Intensity)).replace("DestinationCharacter",C.Name), true);
}
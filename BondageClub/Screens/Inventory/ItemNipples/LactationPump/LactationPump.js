...
function InventoryItemNipplesLactationPumpDraw() {
	ExtendedItemDraw(
		InventoryItemNipplesLactationPumpOptions, "LactationPump", InventoryItemNipplesLactationPumpOptions.length,
		false,
	);
}
...
function InventoryItemNipplesLactationPumpClick() {
	ExtendedItemClick(InventoryItemNipplesLactationPumpOptions, InventoryItemNipplesLactationPumpOptions.length, false);
}

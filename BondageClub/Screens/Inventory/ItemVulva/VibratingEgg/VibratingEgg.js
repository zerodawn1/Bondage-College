...
function InventoryItemVulvaVibratingEggLoad() {
	if (DialogFocusItem.Property == null) DialogFocusItem.Property = { Intensity: 0 };
}
...
function InventoryItemVulvaVibratingEggDraw() {
	...
	if(DialogFocusItem.Property.Intensity < 4) DrawButton(1550, 700, 250, 65, DialogFind(Player, "Increase"), "White");
...
function InventoryItemVulvaVibratingEggClick() {
	...
	if ((MouseX >= 1200) && (MouseX <= 1450) && (MouseY >= 700) && (MouseY <= 765) && (DialogFocusItem.Property.Intensity > 0)) InventorVulvaVibratingEggSetIntensity(-1);
	if ((MouseX >= 1550) && (MouseX <= 1800) && (MouseY >= 700) && (MouseY <= 765) && (DialogFocusItem.Property.Intensity < 4)) InventorVulvaVibratingEggSetIntensity(1);
}

// Sets the pump gag level
function InventorVulvaVibratingEggSetIntensity(Modifier) {
	var C = (Player.FocusGroup != null) ? Player : CurrentCharacter;
	DialogFocusItem.Property.Intensity = DialogFocusItem.Property.Intensity + Modifier;
	if (DialogFocusItem.Property.Intensity == 0) DialogFocusItem.Property.Effect = ["Egged"];
	...
	if (DialogFocusItem.Property.Intensity == 4) DialogFocusItem.Property.Effect = ["Egged", "Vibrating"];	

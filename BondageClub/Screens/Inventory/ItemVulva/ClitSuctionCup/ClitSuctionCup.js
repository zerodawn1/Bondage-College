...
function InventoryItemVulvaClitSuctionCupDraw() {
	ExtendedItemDraw(
		InventoryItemVulvaClitSuctionCupOptions, "SuctionLevel", InventoryItemVulvaClitSuctionCupOptions.length, false);
}
...
function InventoryItemVulvaClitSuctionCupClick() {
	ExtendedItemClick(InventoryItemVulvaClitSuctionCupOptions, InventoryItemVulvaClitSuctionCupOptions.length, false);
}
...
function InventoryItemVulvaClitSuctionCupPublishAction(C, Option, PreviousOption) {
	...
	var msg = "ClitSuc" + ((NewIndex > PreviousIndex) ? "tightens" : "loosens") + "To" + Option.Property.SuctionLevel.toString();
	var Dictionary = [

...
function InventoryItemVulvaClitSuctionCupIntensity(Modifier) {
    ...
    ChatRoomPublishCustomAction((DialogFind(Player, "ClitSuc" + ((Modifier > 0) ? "tightens" : "loosens") + "To" + DialogFocusItem.Property.SuctionLevel)).replace("SourceCharacter",Player.Name).replace("DestinationCharacter",C.Name), true);
} 

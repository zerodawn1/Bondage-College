 ...
 * @returns {void} - Nothing
 */
function InventoryItemArmsOrnateCuffsPublishAction(C, Option, PreviousOption) {
...
function InventoryItemArmsOrnateCuffsNpcDialog(C, Option) {
	C.CurrentDialog = DialogFind(C, "ItemArmsOrnateCuffsNPCReaction" + Option.Name, "ItemArms");
}

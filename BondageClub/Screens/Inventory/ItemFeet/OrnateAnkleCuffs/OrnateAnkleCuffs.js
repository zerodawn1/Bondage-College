...
function InventoryItemFeetOrnateAnkleCuffsDraw() {
	...
	DrawText(DialogFind(Player, "OrnateAnkleCuffsPoseNone"), 1365, 800, "white", "gray");
	...
	DrawText(DialogFind(Player, "OrnateAnkleCuffsPoseClosed"), 1610, 800, "white", "gray");
}

// Catches the item extension clicks
function InventoryItemFeetOrnateAnkleCuffsClick() {
	if ((MouseX >= 1885) && (MouseX <= 1975) && (MouseY >= 25) && (MouseY <= 110)) DialogFocusItem = null;
	if ((MouseX >= 1250) && (MouseX <= 1475) && (MouseY >= 550) && (MouseY <= 775) && (DialogFocusItem.Property.Restrain != null)) InventoryItemFeetOrnateAnkleCuffsSetPose(null);
	if ((MouseX >= 1500) && (MouseX <= 1725) && (MouseY >= 550) && (MouseY <= 775) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Closed"))) InventoryItemFeetOrnateAnkleCuffsSetPose("Closed");
}

// Sets the cuffs pose (wrist, elbow, both or none)
function InventoryItemFeetOrnateAnkleCuffsSetPose(NewPose) {

	// Gets the current item and character
	var C = (Player.FocusGroup != null) ? Player : CurrentCharacter;
	if (CurrentScreen == "ChatRoom") {
		DialogFocusItem = InventoryGet(C, C.FocusGroup.Name);
		InventoryItemFeetOrnateAnkleCuffsLoad();
	}
	...
	CharacterRefresh(C);
	var msg = DialogFind(Player, "OrnateAnkleCuffsRestrain" + ((NewPose == null) ? "None" : NewPose));

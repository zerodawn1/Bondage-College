...
//	DrawText(DialogFind(Player, "SturdyLeatherBeltsPoseFour"), 1875, 800, "white", "gray");
	...
	if (InventoryItemFeetSturdyLeatherBeltsMessage != null) DrawTextWrap(DialogFind(Player, InventoryItemFeetSturdyLeatherBeltsMessage), 1100, 850, 800, 160, "White");
}

// Catches the item extension clicks
function InventoryItemFeetSturdyLeatherBeltsClick() {
	if ((MouseX >= 1885) && (MouseX <= 1975) && (MouseY >= 25) && (MouseY <= 110)) DialogFocusItem = null;
	if ((MouseX >= 1000) && (MouseX <= 1225) && (MouseY >= 550) && (MouseY <= 775) && (DialogFocusItem.Property.Restrain != null)) InventoryItemFeetSturdyLeatherBeltsSetPose(null);
	if ((MouseX >= 1250) && (MouseX <= 1475) && (MouseY >= 550) && (MouseY <= 775) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Two"))) InventoryItemFeetSturdyLeatherBeltsSetPose("Two");
	if ((MouseX >= 1500) && (MouseX <= 1725) && (MouseY >= 550) && (MouseY <= 775) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Three"))) InventoryItemFeetSturdyLeatherBeltsSetPose("Three");
//	if ((MouseX >= 1750) && (MouseX <= 1975) && (MouseY >= 550) && (MouseY <= 775) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Four"))) InventoryItemFeetSturdyLeatherBeltsSetPose("Four");
}

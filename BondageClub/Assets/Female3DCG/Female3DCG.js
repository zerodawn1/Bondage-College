...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "Sandals", Priority: 20, Height: 3, Value: 35 }
		]
	},
...

	{
		...
		Asset: [
			...
			{ Name: "SlaveCollar", Random: false, Effect: ["Lock"], OwnerOnly: true, Extended: true, Enable: false, Value: -1, Time: 5, Difficulty: 50, AllowType: ["SteelPosture", "LeatherPosture"] },

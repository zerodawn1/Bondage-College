...
var AssetFemale3DCG = [
	...
	// Item specific
	{
		...
		Asset: [
			...
			{ Name: "SpreaderMetal", Random: false, Value: 50, Time: 10, Difficulty: 3, Priority: 39, AllowLock: true, Effect: ["Prone"], SetPose: ["LegsOpen"], Block: ["ItemLegs"],  Prerequisite: "LegsOpen", RemoveAtLogin: true },
